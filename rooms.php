...
<ul class="list-group mb-4">
                    ...
                    <div class="row text-center text-sm-start">
                      ...
                      <div class="col-md-4">
                        <div class="text-md-end">
                          ...
                          <div class="d-flex d-md-block align-items-center mb-2 gap-2 justify-content-center justify-content-sm-start">
                            <div class="my-2 mt-md-8 mb-md-4"><span class="text-primary">RP 674.000/</span><s class="text-body">RP 750.000</s></div>
              ...
              <li class="list-group-item p-6">
                <div class="d-flex gap-4 flex-sm-row flex-column align-items-center">
                  <div class="flex-shrink-0 d-flex align-items-center">
                    <img src="assets/img/kamar/double.jpg" alt="deluxe room" class="w-100">
                  </div>
                  <div class="flex-grow-1">
                    <div class="row text-center text-sm-start">
                      <div class="col-md-8">
                        <p class="me-3 mb-2">
                          <span class="text-primary">DOUBLE ROOMS</span></a>
                        </p>
                        <div class="text-body-secondary mb-2 d-flex flex-wrap justify-content-center justify-content-sm-start">
                          <span class="me-1">Status:</span>
                          <span class="badge bg-label-success">Tersedia</span>
                      ...
                      <div class="col-md-4">
                        <div class="text-md-end">
                          <button type="button" class="btn-close btn-pinned" aria-label="Close"></button>
                          <div class="d-flex d-md-block align-items-center mb-2 gap-2 justify-content-center justify-content-sm-start">
                            <div class="my-2 mt-md-8 mb-md-4"><span class="text-primary">RP 1.500.000/</span><s class="text-body">4P 1.600.000</s></div>
                            <!-- <button type="button" class="btn btn-primary">BOOK NOW</button> -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#isidata">BOOK NOW</button>
                          </div>
                        </div>
                ...
                <div class="d-flex gap-4 flex-sm-row flex-column align-items-center">
                  ...
                  <div class="flex-grow-1">
                    <div class="row text-center text-sm-start">
                      <div class="col-md-8">
                        <p class="me-3 mb-2">
                          <span class="text-primary">DELUXE ROOMS</span></a>
                        </p>
                        <div class="text-body-secondary mb-2 d-flex flex-wrap justify-content-center justify-content-sm-start">
                          <span class="me-1">Status:</span>
                          <span class="badge bg-label-success">Tersedia</span>
                      ...
                      <div class="col-md-4">
                        <div class="text-md-end">
                          <button type="button" class="btn-close btn-pinned" aria-label="Close"></button>
                          <div class="d-flex d-md-block align-items-center mb-2 gap-2 justify-content-center justify-content-sm-start">
                            <div class="my-2 mt-md-8 mb-md-4"><span class="text-primary">RP 2.000.000/</span><s class="text-body">RP 2.099.000</s></div>
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#isidata">BOOK NOW</button>
                          </div>
                        </div>
                      </div>
